...
class WordListAdapter(private val dataSet: List<String>, private val onItemClickListener: WordListClickListener) : RecyclerView.Adapter<WordListAdapter.ViewHolder>() {
