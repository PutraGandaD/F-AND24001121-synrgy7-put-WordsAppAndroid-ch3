...
class WordListAdapter(private val dataSet: MutableList<String>, private val onItemClickListener: WordListClickListener) : RecyclerView.Adapter<WordListAdapter.ViewHolder>() {
